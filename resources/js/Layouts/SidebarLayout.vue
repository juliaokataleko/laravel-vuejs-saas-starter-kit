...
<template>
    <div>
        <div class="min-h-screen flex bg-gray-100 flex dark:bg-gray-900">
            <!-- Start Sidebar -->
            <div class="h-screen bg-slate-800 w-[300px]">
            ...
            <!-- Main Content -->
            <div
                class="h-screen overflow-y-auto w-[calc(100vw-300px)] bg-zinc-50"
            >
                <div class=" bg-white shadow-md">
                    <div class="px-5 max-w-[1300px] mx-auto h-16 flex justify-between items-center">
                        ...
                        <div class=" flex items-center space-x-2">
                            <div class="border p-1 px-2 bg-slate-50 rounded-lg flex items-center">
                                ...
                                <input type="text" class=" border-none p-1 bg-transparent" placeholder="Search" />
                            </div>
