...
<template>
            ...
            <div class="h-screen bg-slate-800 w-[300px] fixed md:relative top-0 left-0 bottom-0" :class="{'hidden': !showingSidemenuToogle}">
                ...
                <div class="links h-[calc(100vh-64px)] overflow-y-auto">
                    <div class="px-4 pt-4 space-y-2">
                        ...
                        <div class="space-y-2" v-if="$page.props.auth.user.level == 'admin'">
                            <div>
                                <SidebarLink :href="route('plans.index')" :active="route().current('plans.*')">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                            ...
                            <div>
                                <SidebarLink :href="route('businesses.index')" :active="route().current('businesses.*')">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                            ...
                            <div>
                                <SidebarLink :href="route('subscriptions.index')" :active="route().current('subscriptions.*')">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                            ...
                            <div>
                                <SidebarLink :href="route('countries.index')" :active="route().current('countries.*')">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                            ...
                            <div>
                                <SidebarLink :href="route('states.index')" :active="route().current('states.*')">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M15 10.5a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1 1 15 0Z" />
                                    </svg>
                            ...
                            <div>
                                <SidebarLink :href="route('cities.index')" :active="route().current('cities.*')">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M15 10.5a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1 1 15 0Z" />
                                    </svg>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M15 9h3.75M15 12h3.75M15 15h3.75M4.5 19.5h15a2.25 2.25 0 0 0 2.25-2.25V6.75A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25v10.5A2.25 2.25 0 0 0 4.5 19.5Zm6-10.125a1.875 1.875 0 1 1-3.75 0 1.875 1.875 0 0 1 3.75 0Zm1.294 6.336a6.721 6.721 0 0 1-3.17.789 6.721 6.721 0 0 1-3.168-.789 3.376 3.376 0 0 1 6.338 0Z" />
                            ...
                            <div>
                                <SidebarLink :href="route('payment-methods.index')" :active="route().current('payment-methods.*')">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
  <path stroke-linecap="round" stroke-linejoin="round" d="M15 8.25H9m6 3H9m3 6-3-3h1.5a3 3 0 1 0 0-6M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
                            ...
                            <div>
                                <SidebarLink :href="route('faqs.index')" :active="route().current('faqs.*')">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
  <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 0 0-3.375-3.375h-1.5A1.125 1.125 0 0 1 13.5 7.125v-1.5a3.375 3.375 0 0 0-3.375-3.375H8.25m2.25 0H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 0 0-9-9Z" />
                            ...
                            <div>
                                <SidebarLink :href="route('features.index')" :active="route().current('features.*')">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
  <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 12h16.5m-16.5 3.75h16.5M3.75 19.5h16.5M5.625 4.5h12.75a1.875 1.875 0 0 1 0 3.75H5.625a1.875 1.875 0 0 1 0-3.75Z" />
                        ...
                        <div  v-if="$page.props.auth.user.level == 'admin' || $page.props.auth.user.level == 'manager'">
                            <SidebarLink :href="route('business.users.index')" :active="route().current('business.users.*')">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                        ...
                        <div class=" space-y-2"  v-if="$page.props.auth.user.level == 'manager'">
                            <SidebarLink :href="route('business.settings.edit', $page.props.auth.user.business_id)" :active="route().current('business.settings.*')">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                    ...
                    <div class="px-5 max-w-[1300px] mx-auto h-16 flex justify-between items-center space-x-3">
                        ...
                        <div class=" flex items-center space-x-2">
                            <div class="border p-1 px-2 bg-slate-50 rounded-lg flex items-center">
                                ...
                                <input type="text" class=" w-16 md:w-56 border-none p-1 bg-transparent outline-none" placeholder="Search" />
                            </div>
